package cat.copernic.jose.antonio.miranda.prodiscomtest.ui.app.logged.autorizaciones
...
class resultadosAutorizaciones : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnReturnResultadosAutorizacion.setOnClickListener(Navigation.createNavigateOnClickListener(
            R.id.autorizacion, null))
        binding.btnResultadosAutorizacionToHome.setOnClickListener(Navigation.createNavigateOnClickListener(
