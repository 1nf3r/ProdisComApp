...
import cat.copernic.jose.antonio.miranda.prodiscomtest.ui.message.ChatsDirections
import cat.copernic.jose.antonio.miranda.prodiscomtest.ui.message.ContactsViewModel
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.firestore.auth.User

class ChatsUserCustomAdapter(private val mList: List<ContactsViewModel>) : RecyclerView.Adapter<ChatsUserCustomAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            it.findNavController().navigate(
                UserChatsDirections
                .actionChatsUserToChat(listOfToUsers[position], fromUserData, roomId, holder.txtNom.text.toString() ))
        }
    }
