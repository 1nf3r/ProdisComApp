...
class nuevaAutorizacion : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnReturnNuevaAutorizacion.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.autorizacion, null))
        binding.btnNuevaAutorizacionToHome.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.menu_principal, null))
